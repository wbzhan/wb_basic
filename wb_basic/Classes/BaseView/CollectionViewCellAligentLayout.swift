//
//  CollectionViewCellAligentLayout.swift
//  MarkerMall
//
//  Created by Mac on 18.7.20.
//
...
///设置collectionviewcell对齐方式
public class CollectionViewCellAligentLayout: UICollectionViewFlowLayout {
